    ...
    it("Should validate title is required field if missing", () => {
      ...
      it("Should create an issue and validate it successfully", () => {
        ...
        cy.get('[data-testid="modal:issue-create"]').within(() => {
          ...
          //.trigger("mouseover")
          //.trigger("click");
          cy.get('[data-testid="select:type"]').scrollIntoView();
          ...
          // Select priority "Highest"
          cy.get('[data-testid="select:priority"]').click();
          cy.get('[data-testid="select-option:Lowest"]').click();
        ...
        cy.get('[data-testid="board-list:backlog"]')
          ...
          .within(() => {
            ...
            cy.get('[data-testid="list-issue"]')
              ...
              .within(() => {
                //Assert that correct avatar and type icon are visible
                cy.get('[data-testid="avatar:Lord Gaben"]').should(
                  "be.visible"
                );
                cy.get('[data-testid="icon:task"]').should("be.visible");
              });
        ...
        cy.get('[data-testid="board-list:backlog"]').contains("Task");
        // .within(() => {
        // Assert that correct avatar and type icon are visible
        cy.get('[data-testid="avatar:Lord Gaben"]').should("be.visible");
        cy.get('[data-testid="icon:task"]').should("be.visible");
